                            ...
                            <table id="nhso_table" class="table table-striped table-bordered nowrap" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right">ค่าใช้จ่ายตามเกณฑ์</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-start">{{ $rs->main_hospital }}</td>
                                        <td class="text-center">{{ $rs->hcode }}</td>
                                        <td class="text-start">{{ $rs->visit_hospital }}</td>
                                        <td class="text-center">{{ number_format($rs->cases)." รายการ" }}</td>
